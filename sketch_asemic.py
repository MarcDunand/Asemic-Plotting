...
branchProb = 0.35                       #chance of an accent being added in any given spot
...
charLineHeightNoise = 1             #how much does the character size along an entire line vary (affects all characters on a line)
...
wiggleMin, wiggleMax = -0.2, 0.4    #maximum vertical offset of one char from the next
lineStartMin, lineStartMax = -5, 4            #maximum horizontal offset from one line to the next
lineSpacing = 1.7                  #vertical spacing between lines. 1 is no spacing
...
maxCharShrink = 0.1                     #how much smaller letters get at maximum over the height of the page
scribbleChance = 0.01                 #chance of a scribbled out section
